package com.tailoris.api.order.mapper;
...
public interface OrderInfoMapper extends BaseMapper<OrderInfo> {
    ...
    @Results({
        ...
        @Result(column = "id", property = "orderItems", 
                many = @Many(select = "com.tailoris.api.order.mapper.OrderItemMapper.selectByOrderId")),
        @Result(column = "id", property = "logistics", 
                one = @org.apache.ibatis.annotations.One(select = "com.tailoris.api.order.mapper.OrderLogisticsMapper.selectByOrderId"))
    })
