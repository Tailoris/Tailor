...
public class PayController {
    ...
    @Operation(summary = "微信支付回调", description = "微信支付异步回调通知")
    ...
    public String wechatCallback(HttpServletRequest request) {
        try {
            ...
            paymentService.payCallback(outTradeNo, transactionId, channelResponse, null);
    ...
    public Result<Map<String, Object>> queryWechatOrder(
        ...
        Map<String, Object> result = wechatPayService.queryOrder(transactionId, outTradeNo);
        return Result.success(result);
    }
    ...
    public Result<Map<String, Object>> refund(
        ...
        if ("wechat".equalsIgnoreCase(record.getPayMethod())) {
            result = wechatPayService.refund(paymentNo, refundNo, refundAmount, record.getAmount());
