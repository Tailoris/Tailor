...
|------|:---:|---------|:------:|:------:|
| 代码规范类 | 20 | IDE自动修复+Code Review | W1-W8 | 20/20 |
| 配置类 | 8 | 配置文件改造 | W1-W4 | 8/8 |
| 业务逻辑类 | 12 | 业务开发中同步修复 | W3-W10 | 12/12 |
| 前端类 | 16 | 前端Sprint中处理 | W2-W12 | 16/16 |
| CI/CD类 | 8 | 流水线优化 | W2-W6 | 8/8 |
| 测试类 | 8 | 测试编写时同步 | W3-W16 | 8/8 |
| **合计** | **67** | - | - | **67/67** |
