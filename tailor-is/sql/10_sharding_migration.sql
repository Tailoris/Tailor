...
CREATE TABLE `t_order_0` LIKE `order_info`;

DROP TABLE IF EXISTS `t_order_1`;
CREATE TABLE `t_order_1` LIKE `order_info`;

DROP TABLE IF EXISTS `t_order_2`;
CREATE TABLE `t_order_2` LIKE `order_info`;

DROP TABLE IF EXISTS `t_order_3`;
CREATE TABLE `t_order_3` LIKE `order_info`;
...
CREATE TABLE `t_order_item_0` LIKE `order_item`;

DROP TABLE IF EXISTS `t_order_item_1`;
CREATE TABLE `t_order_item_1` LIKE `order_item`;

DROP TABLE IF EXISTS `t_order_item_2`;
CREATE TABLE `t_order_item_2` LIKE `order_item`;

DROP TABLE IF EXISTS `t_order_item_3`;
CREATE TABLE `t_order_item_3` LIKE `order_item`;
...
CREATE TABLE `t_shopping_cart_0` LIKE `shopping_cart`;

DROP TABLE IF EXISTS `t_shopping_cart_1`;
CREATE TABLE `t_shopping_cart_1` LIKE `shopping_cart`;

DROP TABLE IF EXISTS `t_shopping_cart_2`;
CREATE TABLE `t_shopping_cart_2` LIKE `shopping_cart`;

DROP TABLE IF EXISTS `t_shopping_cart_3`;
CREATE TABLE `t_shopping_cart_3` LIKE `shopping_cart`;
...
CREATE TABLE `t_after_sale_ticket_0` LIKE `after_sale_ticket`;

DROP TABLE IF EXISTS `t_after_sale_ticket_1`;
CREATE TABLE `t_after_sale_ticket_1` LIKE `after_sale_ticket`;

DROP TABLE IF EXISTS `t_after_sale_ticket_2`;
CREATE TABLE `t_after_sale_ticket_2` LIKE `after_sale_ticket`;

DROP TABLE IF EXISTS `t_after_sale_ticket_3`;
CREATE TABLE `t_after_sale_ticket_3` LIKE `after_sale_ticket`;
...
CREATE TABLE `t_payment_record_0` LIKE `payment_record`;

DROP TABLE IF EXISTS `t_payment_record_1`;
CREATE TABLE `t_payment_record_1` LIKE `payment_record`;

DROP TABLE IF EXISTS `t_payment_record_2`;
CREATE TABLE `t_payment_record_2` LIKE `payment_record`;

DROP TABLE IF EXISTS `t_payment_record_3`;
CREATE TABLE `t_payment_record_3` LIKE `payment_record`;
...
CREATE TABLE `t_refund_record_0` LIKE `refund_record`;

DROP TABLE IF EXISTS `t_refund_record_1`;
CREATE TABLE `t_refund_record_1` LIKE `refund_record`;

DROP TABLE IF EXISTS `t_refund_record_2`;
CREATE TABLE `t_refund_record_2` LIKE `refund_record`;

DROP TABLE IF EXISTS `t_refund_record_3`;
CREATE TABLE `t_refund_record_3` LIKE `refund_record`;
...
CREATE TABLE `t_settlement_record_0` LIKE `settlement_record`;

DROP TABLE IF EXISTS `t_settlement_record_1`;
CREATE TABLE `t_settlement_record_1` LIKE `settlement_record`;

DROP TABLE IF EXISTS `t_settlement_record_2`;
CREATE TABLE `t_settlement_record_2` LIKE `settlement_record`;

DROP TABLE IF EXISTS `t_settlement_record_3`;
CREATE TABLE `t_settlement_record_3` LIKE `settlement_record`;
...
CREATE TABLE `t_withdraw_record_0` LIKE `withdraw_record`;

DROP TABLE IF EXISTS `t_withdraw_record_1`;
CREATE TABLE `t_withdraw_record_1` LIKE `withdraw_record`;

DROP TABLE IF EXISTS `t_withdraw_record_2`;
CREATE TABLE `t_withdraw_record_2` LIKE `withdraw_record`;

DROP TABLE IF EXISTS `t_withdraw_record_3`;
CREATE TABLE `t_withdraw_record_3` LIKE `withdraw_record`;
...
CREATE TABLE `t_account_transaction_0` LIKE `account_transaction`;

DROP TABLE IF EXISTS `t_account_transaction_1`;
CREATE TABLE `t_account_transaction_1` LIKE `account_transaction`;

DROP TABLE IF EXISTS `t_account_transaction_2`;
CREATE TABLE `t_account_transaction_2` LIKE `account_transaction`;

DROP TABLE IF EXISTS `t_account_transaction_3`;
CREATE TABLE `t_account_transaction_3` LIKE `account_transaction`;
