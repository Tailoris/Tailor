...
启动后访问: http://localhost:8111/doc.html
...
| 配置项 | 说明 | 默认值 |
|--------|------|--------|
| server.port | 服务端口 | 8111 |
| spring.cloud.nacos.discovery.server-addr | Nacos地址 | ${NACOS_ADDR} |
| spring.datasource.url | 数据库连接 | jdbc:mysql://${MYSQL_HOST}:${MYSQL_PORT}/tailor_is_message |
